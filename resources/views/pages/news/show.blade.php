...
@section('title', 'BRQ News - ' . $news->title)
@section('content')
<!-- Detail Berita -->
  <div class="flex flex-col px-4 lg:px-14 mt-10">
    ...
    <div class="flex flex-col lg:flex-row w-full gap-10">
      ...
      <div class="lg:w-8/12">
        ...
        <p class="font-bold text-lg lg:text-xl mt-6">{{ $news->title }}</p>
        {!! $news->content !!}
      </div>
      <!-- Berita Terbaru -->
            ...
            <a href="detail-MotoGp.html">
              <div class="flex gap-3 border border-slate-300 hover:border-primary p-3 rounded-xl">
                ...
                <div class="flex gap-3 flex-col lg:flex-row">
                  <img src="{{ asset('storage/' . $new->thumbnail) }}" alt="" class="max-h-36 rounded-xl object-cover" style="width:160px;">
                  <div class="">
