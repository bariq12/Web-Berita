      ...
      <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        @foreach ($news->skip(1) as $newsItem)
          <a href="{{ route('news.show', $newsItem->slug) }}"
            ...
            <img src="{{ asset('storage/' . $newsItem->thumbnail) }}" alt="berita2" class="rounded-xl sm:w-full md:max-h-48" style="width: 250px; object-fit:cover;">
